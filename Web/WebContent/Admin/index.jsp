...
<head>
		<meta charset="utf-8">
		<title>控制台</title>
		<link rel="stylesheet" type="text/css" href="../Css/Admin/identify.css" />
		...
		<link rel="stylesheet" type="text/css" href="../Css/Admin/control_index.css" />
		<script type="text/javascript" src="../Js/Admin/jquery-1.7.2.min.js"></script>
		<script type="text/javascript" src="../Js/Admin/layer/layer.js"></script>
		<script type="text/javascript" src="../Js/Admin/haidao.offcial.general.js"></script>
		<script type="text/javascript" src="../Js/Admin/select.js"></script>
		<script type="text/javascript" src="../Js/Admin/haidao.validate.js"></script>
		...
		<div class="view-topbar">
			<div class="topbar-console">
				<div class="tobar-head fl">
					...
					<span><img src="../Img/Admin/logo.png" width="20" height="20"/></span>
					</a>
				...
				<div class="sidebar-content">
					<div class="sidebar-nav">
						...
						<ul class="sidebar-trans">
							<li>
								<a href="webSet.html">
									<b class="sidebar-icon"><img src="../Img/Admin/icon_author.png" width="16" height="16" /></b>
									<span class="text-normal">站点管理</span>
								</a>
							</li>
							<li>
								<a href="smsInfo.html">
									<b class="sidebar-icon"><img src="../Img/Admin/icon_message.png" width="16" height="16" /></b>
						...
						<ul class="sidebar-trans">
							<li>
								<a href="userInfo.html">
									<b class="sidebar-icon"><img src="../Img/Admin/icon_cost.png" width="16" height="16" /></b>
									<span class="text-normal">账号管理</span>
								</a>
							</li>
							<li>
								<a href="identify.html">
									<b class="sidebar-icon"><img src="../Img/Admin/icon_authentication.png" width="16" height="16" /></b>
									<span class="text-normal">实名认证</span>
								</a>
							</li>
							<li>
								<a href="message.html">
									<b class="sidebar-icon"><img src="../Img/Admin/icon_news.png" width="16" height="16" /></b>
									<span class="text-normal">消息中心</span>
								</a>
							</li>
							<li>
								<a href="money.html">
									<b class="sidebar-icon"><img src="../Img/Admin/icon_gold.png" width="16" height="16" /></b>
									<span class="text-normal">金币管理</span>
								</a>
							</li>
							<li>
								<a href="order.html">
									<b class="sidebar-icon"><img src="../Img/Admin/icon_order.png" width="16" height="16" /></b>
							...
							<dl>
								<dt class="padding-big-left lists-border-list clearfix">
									...
									<span class="fr icon-head">
										<img src="../Img/Admin/noavatar_middle.gif" alt="账户头像">
									</span>
								</dt>
